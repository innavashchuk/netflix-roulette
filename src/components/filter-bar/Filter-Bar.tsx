...
import {
    ...
    SORTING_FIELDS, SortingFieldsEnum,
    ...
    return (
        <div className="filter-tab">
            ...
            <div className="filter-tab__sort">
                ...
                <button aria-label="SORT ORDER" className="filter-tab__sort_btn button-dark filter-tab__sort_direction"
                        onClick={onClickToggleSortDirection}>
