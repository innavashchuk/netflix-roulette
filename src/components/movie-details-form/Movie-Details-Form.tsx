        ...
        <div className="movie-details">
            ...
            <Formik
                ...
                {({
                      ...
                      touched,
                      values
                  }: FormikProps<InitialMovieValues>) =>
                    <Form className="movie-details__form" onSubmit={handleSubmit} autoComplete="off">
                        {
                            props.isEdit &&
                            <InputTextField name="title" type="text" className="movie-details__form_input"
                                            value={values.id} disabled label="ID"/>
                        }
                        <InputTextField
                            name="title"
                            type="text"
                        ...
                        {errors.release_date && <p className="validation-error-display">{errors.release_date}</p>}
                        ...
                        <Select
                            ...
                            input={<Input
                                className={`form-input ${errors.genres && touched.genres ? ' invalid-field' : ''}`}/>}
                        ...
                        {errors.genres && touched.genres && <p className="validation-error-display">{errors.genres}</p>}

                        <label htmlFor="overview" className="form-label">OVERVIEW</label>
                        <TextareaAutosize
                            className={`movie-details__form_input ${errors.overview && touched.overview ? ' invalid-field' : ''}`}
                            name="overview"
                        ...
                        <p className="validation-error-display">{errors.overview}</p>}
                        ...
                        <div className="movie-details__btns">
                            <button className="button-secondary" type="reset" onClick={handleReset} name="reset">RESET
                            </button>
                            <button className={`button-primary${!isValid ? ' button-invalid' : ''}`}
