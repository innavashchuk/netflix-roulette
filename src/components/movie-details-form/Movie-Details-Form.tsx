        ...
        <Formik
          ...
          {({handleSubmit, handleReset, handleChange, setFieldTouched, isValid, errors, touched, values}: FormikProps<InitialMovieValues>) =>
              <Form className="movie-details__form" onSubmit={handleSubmit} autoComplete="off">
                {
                  props.isEdit && <InputTextField name="title" type="text" className="movie-details__form_input" value={values.id} disabled label="ID" />
                }
                <InputTextField
                    name="title"
                    type="text"
                ...
                />
                {errors.overview && touched.overview && <p className="validation-error-display">{errors.overview}</p>}
